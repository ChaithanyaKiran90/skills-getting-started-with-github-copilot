...
activities = {
    ...
    "Basketball Club": {
        "description": "Pickup games, skill development, and intramural play",
    ...
    "Orchestra": {
        "description": "Instrumental rehearsals and performances throughout the year",
        "schedule": "Tuesdays, 4:00 PM - 6:00 PM",
        "max_participants": 40,
        "participants": ["elijah@mergington.edu", "charlotte@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice formal debate formats and compete at tournaments",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["lucas@mergington.edu", "amelia@mergington.edu"]
    },
    "Math Club": {
        "description": "Problem solving, math contests, and collaborative exploration",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Add student to the requested activity
